...
export REPOFLOW_GRAPHQL_VERSION=1.73.8-master #module @nebulario/nodeflow-local-graph
export REPOFLOW_WEB_VERSION=1.71.12-master #module @nebulario/nodeflow-local-server
export REPOFLOW_PLUGIN_VERSION=1.70.2-master #module @nebulario/repoflow-plugin-server
