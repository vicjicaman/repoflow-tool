...
export REPOFLOW_GRAPHQL_VERSION=1.70.0-repoflow-tool-script-prod #module @nebulario/nodeflow-local-graph
export REPOFLOW_WEB_VERSION=1.70.0-repoflow-tool-script-prod #module @nebulario/nodeflow-local-server
export REPOFLOW_PLUGIN_VERSION=1.70.0-repoflow-tool-script-prod #module @nebulario/repoflow-plugin-server
